...
The internal Slovak console is at `/admin` and `admin.befitliner.com`, restricted
in the database to the confirmed `peter@peterbudzak.com` account. See
[deployment, data definitions and Stripe setup](docs/admin-console.md).
Run `npm run check:admin` for financial and payment-state regression checks.
